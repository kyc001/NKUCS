	...
	%设置实验人信息以及实验时间表格
		...
		\begin{center}
			\begin{tabular}{lcr}
				...
				{\songti  学院：计算机学院 \quad 时间：2025年4月22日 \quad 组别: L组11号}\\
...
\par
	\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/分光仪结构.png}
	\caption{分光仪结构示意图}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/望远镜结构.png}
	\caption{望远镜结构示意图}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/各半调节法.png}
	\caption{各半调节法示意图}
\end{figure}
...
\subsubsection*{用各半调节法使望远镜的光轴与仪器转轴垂直}
需要注意调整的顺序。
需要保证载物台是⼤致⽔平的，看中间的缝隙各个⽅向是否⼀致。
如果将半透半反镜放置于载物台上的线重合，可以只调两个俯仰螺。
...
\hline
游标号 & 望远镜筒位置1 & 望远镜筒位置2 & 望远镜筒转过的角度 & 消偏心差角度 \\
\hline
1 & 246^{\circ}43' & 202^{\circ}58' & 43^{\circ}45' & \multirow{2}{*}{43^{\circ}45'} \\
\cline{1-4} % 只画前4列的横线
2 & 66^{\circ}45' & 23^{\circ}00' & 43^{\circ}45' & \\
\hline
\end{tabular}
